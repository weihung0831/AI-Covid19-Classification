...
def load_data(data, class_num, class_name):
    """
    The load_data function loads the data into memory.

    :param data: Store the file name and label of each image
    :param class_num: Specify the class number of the data
    :param class_name: Change the label of the class from a number to a string
    :return: The data, class_num and class_name
    """
...
def load_image(data, directory):
    """
    The load_image function loads the image into memory.
...
def load_label(data, class_name, class_num):
    """
    The load_label function loads the label into memory.

    :param data: Store the file name and label of each image
    :param class_name: Specify the class that is being loaded
    :param class_num: Specify the number of classes
    :return: The label of each image in the dataset
    """
